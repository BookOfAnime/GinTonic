          ...
          >
            ...
            <g clipPath="url(#cupClip)">
              ...
              {iceCubes.map((cube, i) => (
                <g
                  key={i}
                  transform={`translate(${cube.x}, ${cube.y}) rotate(${cube.rotation})`}
                >
                  <rect
                    x={-cube.size / 2}
                    y={-cube.size / 2}
            ...
            {/* Cup highlight */}
            <path
              d="M 50,50 Q 70,40 90,38 L 310,38 Q 330,40 350,50"
              fill="none"
...
const Feature = ({ icon, title, description }) => (
  <div className="bg-zinc-800 p-6 rounded-lg shadow-md">
    ...
    <h3 className="text-2xl font-semibold mt-4 mb-2 text-center text-[#0098EA]">
      {title}
    </h3>
...
const ShotGlass = ({ fillPercentage }) => (
  <div className="fixed right-8 top-1/2 transform -translate-y-1/2 w-24 h-40 pointer-events-none">
    <svg viewBox="0 0 100 160" className="w-full h-full">
      <path
        d="M10 10 L30 150 L70 150 L90 10 Z"
        fill="none"
        stroke="#0098EA"
        strokeWidth="2"
      />
      <path
        d={`M30 150 L70 150 L${90 - 60 * (1 - fillPercentage)} ${
          10 + 140 * (1 - fillPercentage)
        } L${10 + 60 * (1 - fillPercentage)} ${
          10 + 140 * (1 - fillPercentage)
        } Z`}
        fill="#0098EA"
      />
...
const App = () => {
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-zinc-900 text-white relative overflow-hidden ${
          showLanding ? "hidden" : ""
        }`}
      >
        ...
        <main className="container mx-auto px-4 py-12 relative z-10">
          <div className="max-w-3xl mx-auto">
            <section id="about" className="mb-16">
              <h2 className="text-4xl font-bold mb-6 text-center text-[#0098EA]">
                Tired of being sober?
              </h2>
              <p className="text-xl text-center text-gray-300">
                Gin and Tonic provides the perfect solution! Enjoy our
                proprietary gin mixed with world-class tonic, only available on
                the Ton chain. We're in the early stages of developing our
                formula and will soon be partnering with Dedust Bar & Grill to
                make it available for all to enjoy.
              </p>
            </section>
            ...
            <section id="features" className="grid md:grid-cols-3 gap-8 mb-16">
              <Feature
                ...
                description="Our Gin and Tonic is aged to perfection, with returns that will make your head spin!"
              />
              <Feature
            ...
            <section id="invest" className="text-center">
              <h2 className="text-4xl font-bold mb-6 text-[#0098EA]">
              Don't fade—get faded.
